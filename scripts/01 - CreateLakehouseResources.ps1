...
There is a sample starting one in the github repo called paramfile06.json 
...
& "C:\PSScripts\01 - CreateLakehouseResources.ps1" -filepath "C:\PSScripts\paramfile06.json"
...
More info can be found at <github location> 
